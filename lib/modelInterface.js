    ...
    return function(modelName) {
      return function(socket) {
        ...
        socket.on("find", (function(_this) {
          return function(request) {
            if ((request != null ? request.token : void 0) != null) {
              return _this.find(request.content, socket, modelName).then(function(data) {
                return {
                  success: true,
                  content: data
                };
        ...
        socket.on("count", (function(_this) {
          return function(request) {
            if ((request != null ? request.token : void 0) != null) {
              return _this.count(request.content, socket, modelName).then(function(count) {
                return {
                  success: true,
                  content: count
                };
        ...
        socket.on("insert", (function(_this) {
          return function(request) {
            if ((request != null ? request.token : void 0) != null) {
              return _this.insert(request.content, socket, modelName).then(function(modelObj) {
        ...
        socket.on("update", (function(_this) {
          return function(request) {
            if ((request != null ? request.token : void 0) != null) {
              return _this.update(request.content, socket, modelName).then(function(modelObj) {
        ...
        return socket.on("remove", (function(_this) {
          return function(request) {
            if ((request != null ? request.token : void 0) != null) {
              return _this.remove(request.content, socket, modelName).then(function(id) {
