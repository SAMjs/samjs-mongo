    ...
    return function(model) {
      ...
      model.find = function(query, socket, addName) {
        ...
        return model._hooks.beforeFind({
          ...
          var dbquery, k, len2, modelname, pop, populate, query, ref3, ref4, ref5, schemaobj;
          query = arg.query;
          ...
          if (populate != null) {
            for (k = 0, len2 = populate.length; k < len2; k++) {
              pop = populate[k];
              modelname = pop.model;
              if ((pop.path != null) && (modelname == null)) {
                schemaobj = model.schema.path(pop.path);
                if (schemaobj != null) {
                  modelname = (ref3 = schemaobj.options) != null ? ref3.ref : void 0;
                  if (modelname == null) {
                    modelname = (ref4 = schemaobj.caster) != null ? (ref5 = ref4.options) != null ? ref5.ref : void 0 : void 0;
                  }
                }
              }
              if (samjs.models[modelname] == null) {
      ...
      model.update = function(query, socket, addName) {
        ...
        if (query.doc._id != null) {
          delete query.doc._id;
        }
        if (query.doc.__v != null) {
          delete query.doc.__v;
        }
